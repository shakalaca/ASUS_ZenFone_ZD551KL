...
int Olivia_device_tof_configuration_interface(struct msm_laser_focus_ctrl_t *dev_t, int ctrl){
	...
	uint16_t config_cal_10_olivia[LAURA_CONFIG_SIZE] = {0xE100, 0x30FF, 0x07D0, 0x5001, 0xA141, 0x4590};
	uint16_t config_cal_40_olivia[LAURA_CONFIG_SIZE] = {0xE100, 0x30FF, 0x07D0, 0x5001, 0xA3C1, 0x4590};
